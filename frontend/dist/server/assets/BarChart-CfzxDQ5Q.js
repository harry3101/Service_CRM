import { $ as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React } from "./worker-entry-BZNBjeUw.js";
function r(e) {
  var t, f, n = "";
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    return _objectSpread$n(_objectSpread$n({}, result), {}, _defineProperty$q({}, id, finalAxis));
  }, {});
};
...
export {
  ...
  Layer as L,
  useOffset as M,
  useArbitraryXAxis as N,
  useYAxisWithFiniteDomainOrRandom as O,
  getCoordinatesOfGrid as P,
  getTicks as Q,
  ...
  YAxis as Y,
  hasClipDot as Z,
  getCateCoordinateOfLine as _,
  require_baseGt as a,
  require_baseIteratee as b,
  clsx as c,
  require_baseLt as d,
  adaptEventsOfChild as e,
  filterProps as f,
  getTickClassName as g,
  Label as h,
  isFunction as i,
  isNil as j,
  getValueByDataKey as k,
  get as l,
  interpolateNumber$2 as m,
  isEqual as n,
  isNumber as o,
  ...
  Cell as v,
  getMaxRadius as w,
  getPercentValue as x,
  warn as y,
  generateCategoricalChart as z
};
