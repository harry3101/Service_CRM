import { T as React, P as getDefaultExportFromCjs, r as reactExports, U as jsxRuntimeExports } from "./worker-entry-D8zzwFOR.js";
import { b as api } from "./router-DcoUKonF.js";
import { P as Panel } from "./Panel-CashBaQX.js";
import { S as StatusBadge } from "./StatusBadge-B9z-cIVH.js";
import { I as IndianRupee } from "./indian-rupee-Bz8q1jon.js";
import { P as PhoneCall, a as Package } from "./phone-call-BSh2tlh6.js";
import { U as UserCheck } from "./user-check-C8HleGQ0.js";
import { c as clsx, f as filterProps, r as require_baseExtremum, a as require_baseGt, b as require_baseIteratee, d as require_baseLt, i as isFunction, T as Text, p as polarToCartesian, L as Layer, g as getTickClassName, e as adaptEventsOfChild, h as Label, D as Dot, C as Curve, j as isNil, k as getValueByDataKey, S as Shape, A as Animate, l as get, m as interpolateNumber, n as isEqual, o as isNumber, q as LabelList, u as uniqueId, G as Global, s as mathSign, t as findAllByType, v as Cell, w as getMaxRadius, x as getPercentValue, y as warn, z as generateCategoricalChart, B as formatAxisMap, R as ResponsiveContainer, E as BarChart, X as XAxis, Y as YAxis, F as Tooltip, H as Bar, I as Legend } from "./BarChart-DP4wTNcu.js";
import { c as createLucideIcon } from "./createLucideIcon-DuCBdKa-.js";
import { T as TriangleAlert } from "./triangle-alert-aWOC_UOy.js";
import "node:events";
...
function Dashboard() {
  ...
  const [revenueChart, setRevenueChart] = reactExports.useState([]);
  const [statusPie, setStatusPie] = reactExports.useState([]);
  reactExports.useEffect(() => {
    (async () => {
      const [callRows, revRows, invRows] = await Promise.all([api.getServiceCalls(), api.getRevenue(), api.getInventory()]);
      ...
      setRevenueChart(Object.entries(map).map(([month, amount]) => ({
        month,
        amount
      })));
      const sMap = {};
      ...
      setStatusPie(Object.entries(sMap).map(([name, value]) => ({
        name,
        value
      })));
    })();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { icon: IndianRupee, label: "Total Revenue", value: `₹${kpis.totalRevenue.toLocaleString("en-IN")}`, accent: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { icon: PhoneCall, label: "Open Calls", value: kpis.openCalls, accent: "info" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { icon: UserCheck, label: "In Progress", value: kpis.allocated, accent: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiCard, { icon: Package, label: "Low Stock Items", value: kpis.lowStock, accent: "destructive" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Revenue Trend", className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        width: "100%",
        height: 220
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: revenueChart, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "amount", fill: "oklch(0.45 0.16 255)" })
      ] }) }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Calls by Status", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        width: "100%",
        height: 220
      }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: statusPie, dataKey: "value", nameKey: "name", outerRadius: 70, label: {
          fontSize: 10
        }, children: statusPie.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: PIE_COLORS[i % PIE_COLORS.length] }, i)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, { wrapperStyle: {
          fontSize: 11
        } })
      ] }) }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Recent Service Calls", actions: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/calls", className: "text-[11px] text-primary hover:underline", children: "View all →" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "crm-table", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: recent.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStat, { icon: TrendingUp, label: "Total Calls", value: kpis.totalCalls }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStat, { icon: UserCheck, label: "Closed", value: kpis.closedCalls }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStat, { icon: TriangleAlert, label: "Items to Reorder", value: kpis.lowStock })
    ] })
  ] });
}
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "crm-panel flex items-center gap-3 p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex h-10 w-10 items-center justify-center rounded ${accentMap[accent]}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-foreground", children: value })
    ] })
  ] });
}
function MiniStat({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "crm-panel flex items-center justify-between p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase text-muted-foreground", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-semibold text-foreground", children: value })
    ] }),
