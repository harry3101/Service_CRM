import { T as React, r as reactExports, U as jsxRuntimeExports } from "./worker-entry-D8zzwFOR.js";
import { b as api } from "./router-DcoUKonF.js";
import { P as Panel } from "./Panel-CashBaQX.js";
import { J as useChartWidth, K as useChartHeight, M as useOffset, o as isNumber, N as useArbitraryXAxis, O as useYAxisWithFiniteDomainOrRandom, i as isFunction, y as warn, P as getCoordinatesOfGrid, Q as getTicks, U as getTicksOfAxis, V as CartesianAxis, f as filterProps, c as clsx, D as Dot, t as findAllByType, W as ErrorBar, L as Layer, C as Curve, A as Animate, m as interpolateNumber, n as isEqual, j as isNil, Z as hasClipDot, q as LabelList, k as getValueByDataKey, u as uniqueId, G as Global, _ as getCateCoordinateOfLine, z as generateCategoricalChart, X as XAxis, Y as YAxis, $ as formatAxisMap, R as ResponsiveContainer, F as Tooltip, I as Legend, E as BarChart, H as Bar } from "./BarChart-DP4wTNcu.js";
import "node:events";
...
function Reports() {
  const [revByMonth, setRevByMonth] = reactExports.useState([]);
  const [callsByPriority, setCallsByPriority] = reactExports.useState([]);
  const [callsByCity, setCallsByCity] = reactExports.useState([]);
  const [engineerLoad, setEngineerLoad] = reactExports.useState([]);
  reactExports.useEffect(() => {
    (async () => {
      const raw = await api.getReportsRaw();
      const rev = {
        data: raw.revenue
      };
      const calls = {
        data: raw.service_calls
      };
      const alloc = {
        data: raw.call_allocations
      };
      const rmap = {};
      ...
      setRevByMonth(Object.entries(rmap).map(([month, amount]) => ({
        month,
        amount
      })));
      const pmap = {};
      ...
      setCallsByPriority(Object.entries(pmap).map(([priority, count]) => ({
        priority,
        count
      })));
      const cmap = {};
      ...
      setCallsByCity(Object.entries(cmap).map(([city, count]) => ({
        city,
        count
      })));
      const emap = {};
      ...
      setEngineerLoad(Object.entries(emap).map(([engineer, calls2]) => ({
        engineer,
        calls: calls2
      })));
    })();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3 lg:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Monthly Revenue (₹)", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      width: "100%",
      height: 240
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: revByMonth, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 250)" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "amount", stroke: "oklch(0.45 0.16 255)", strokeWidth: 2 })
    ] }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Calls by Priority", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      width: "100%",
      height: 240
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: callsByPriority, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 250)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "priority", tick: {
        fontSize: 11
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { tick: {
        fontSize: 11
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "oklch(0.55 0.18 30)" })
    ] }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Calls by City", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      width: "100%",
      height: 240
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: callsByCity, layout: "vertical", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 250)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { type: "number", tick: {
        fontSize: 11
      } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { type: "category", dataKey: "city", tick: {
        fontSize: 11
      }, width: 80 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "oklch(0.6 0.15 200)" })
    ] }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Panel, { title: "Engineer Allocation Load", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      width: "100%",
      height: 240
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: engineerLoad, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.9 0.01 250)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "engineer", tick: {
        fontSize: 10
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "calls", fill: "oklch(0.5 0.15 150)" })
    ] }) }) }) })
  ] });
}
export {
