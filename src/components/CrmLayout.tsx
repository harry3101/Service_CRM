...
export default function CrmLayout() {
  ...
  const title = TITLES[loc.pathname] ?? "Symphony Service CRM";
    ...
    <div className="flex h-screen flex-col bg-background">
      ...
      <header className="flex h-12 items-center justify-between bg-header px-3 text-header-foreground shadow">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-white/10 font-bold text-white">S</div>
          <div>
            <div className="text-sm font-bold leading-tight">Symphony</div>
            <div className="text-[10px] leading-tight opacity-75">Service Center CRM</div>
          </div>
        </div>
